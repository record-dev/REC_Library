...
---@class REC_Library.Shared.Class.Zone.PolyZoneConfigBuilder
...
local PolyZoneConfigBuilder = {}
PolyZoneConfigBuilder.__index = PolyZoneConfigBuilder

---instantiation
---@param points vector3[] coordinate table
---@return self
function PolyZoneConfigBuilder:new(points)
...
function PolyZoneConfigBuilder:setTickness(thickness)
    if thickness == nil then return self end
    assert(type(thickness) == "number")
    self.thickness = thickness return self
end

---@param onEnter fun(self: REC_Library.Shared.Zone.Self)|nil
---@return self chain method
function PolyZoneConfigBuilder:setOnEnter(onEnter)
...
---@return self chain method
function PolyZoneConfigBuilder:setOnExit(onExit)
...
---@return self chain method
function PolyZoneConfigBuilder:setOnInside(onInside)
...
---@return self chain method
function PolyZoneConfigBuilder:setDebug(debug)
...
---@return self chain method
function PolyZoneConfigBuilder:setDebugColour(debugColour)
...
---@return self chain method
function PolyZoneConfigBuilder:setDebugColourAlpha(alpha)
...
---@return table
function PolyZoneConfigBuilder:build()
    local finalOptions = {}
